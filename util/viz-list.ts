import { VizItem } from "./viz-types";
import { favoriteVizList } from "./favorite-viz-list";
// Re-export the shared types & vocab so existing `from "./viz-list"` imports keep working.
export * from "./viz-types";

// `vizList` holds every NON-favorite entry — this is where new entries are appended.
// The favorites live in their own small module (favorite-viz-list.ts) so the homepage
// can show them without loading this big file. `fullVizList` re-merges the two (sorted
// by id, the original authoring order) for anything that needs the complete catalog:
// the chart-type pages, the about page, and the homepage's filtered view.
export const vizList: VizItem[] = [
    {
        ...
        img: { full: "covid19India-bar.webp", zoom: "covid19India-bar-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "Group of dedicated volunteers",
        url: "https://www.covid19india.org",
        img: { full: "covid19India-line.webp", zoom: "covid19India-line-zoom.webp", chartId: ["line"] },
        contextDescription: "The covid crisis is a world wide pandemic and India is certainly not spared. Some volunteer decided to create a dashboard to help Indian politics to take information driven decisions.",
    ...
    },
    {
        ...
        img: { full: "migration-waves.webp", zoom: "migration-waves-zoom.webp", chartId: ["density", "ridgeline"] },
    ...
    },
    {
        ...
        img: { full: "russia-gas-ukraine.webp", zoom: "russia-gas-ukraine-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "lollipop-plot-with-r-mario-kart-64-world-records.webp", zoom: "lollipop-plot-with-r-mario-kart-64-world-records-zoom.webp", chartId: ["lollipop"] },
    ...
    },
    {
        ...
        img: { full: "streamchart-xmen.webp", zoom: "streamchart-xmen-zoom.webp", chartId: ["stream"] },
    ...
    },
    {
        ...
        img: { full: "web-circular-lollipop-plot-with-ggplot2.webp", zoom: "web-circular-lollipop-plot-with-ggplot2-zoom.webp", chartId: ["lollipop", "circularBarplot"] },
    ...
    },
    {
        ...
        img: { full: "infection-from-lab.webp", zoom: "infection-from-lab-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "HBCU_trends_gender.webp", zoom: "HBCU_trends_gender-zoom.webp", chartId: ["lollipop"] },
    ...
    },
    {
        ...
        img: { full: "covid-dash-lemonde-1.webp", zoom: "covid-dash-lemonde-1.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        author: "Le Monde",
        url: "https://www.lemonde.fr/les-decodeurs/article/2020/05/05/coronavirus-age-mortalite-departements-pays-suivez-l-evolution-de-l-epidemie-en-cartes-et-graphiques_6038751_4355770.html",
        img: { full: "covid-dash-lemonde-2.webp", zoom: "covid-dash-lemonde-2-zoom.webp", chartId: ["line"] },
        contextDescription: "Covid is everywhere in the news and every newspaper is trying to summarize the situation in its country. Le Monde is one of the most famous newspapers in France and does a pretty good job in its daily updated dashboard.",
    ...
    },
    {
        ...
        author: "Le Monde",
        url: "https://www.lemonde.fr/les-decodeurs/article/2020/05/05/coronavirus-age-mortalite-departements-pays-suivez-l-evolution-de-l-epidemie-en-cartes-et-graphiques_6038751_4355770.html",
        img: { full: "covid-dash-lemonde-3.webp", zoom: "covid-dash-lemonde-3-zoom.webp", chartId: ["stream"] },
        contextDescription: "Covid is everywhere in the news and every newspaper is trying to summarize the situation in its country. Le Monde is one of the most famous newspapers in France and does a pretty good job in its daily updated dashboard.",
    ...
    },
    {
        ...
        author: "Le Monde",
        url: "https://www.lemonde.fr/les-decodeurs/article/2020/05/05/coronavirus-age-mortalite-departements-pays-suivez-l-evolution-de-l-epidemie-en-cartes-et-graphiques_6038751_4355770.html",
        img: { full: "covid-dash-lemonde-4.webp", zoom: "covid-dash-lemonde-4.webp", chartId: ["line", "barplot"] },
        contextDescription: "Covid is everywhere in the news and every newspaper is trying to summarize the situation in its country. Le Monde is one of the most famous newspapers in France and does a pretty good job in its daily updated dashboard.",
    ...
    },
    {
        ...
        url: "https://www.lemonde.fr/les-decodeurs/article/2020/05/05/coronavirus-age-mortalite-departements-pays-suivez-l-evolution-de-l-epidemie-en-cartes-et-graphiques_6038751_4355770.html",
        img: { full: "scientific-pub-connection.webp", zoom: "scientific-pub-connection-zoom.webp", chartId: ["edgeBundling"] },
    ...
    },
    {
        ...
        img: { full: "map-inequality-spain.webp", zoom: "map-inequality-spain-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "Troops-vs-Costs.webp", zoom: "Troops-vs-Costs-zoom.webp", chartId: ["connectedScatter"] },
    ...
    },
    {
        ...
        img: { full: "vaccine-heatmap.webp", zoom: "vaccine-heatmap-zoom.webp", chartId: ["heatmap"] },
    ...
    },
    {
        ...
        img: { full: "east-vs-west-germany.webp", zoom: "east-vs-west-germany-zoom.webp", chartId: ["hexbin"] },
    ...
    },
    {
        ...
        img: { full: "nobel-prices.webp", zoom: "nobel-prices-zoom.webp", chartId: ["line", "sankey", "barplot"] },
    ...
    },
    {
        ...
        img: { full: "shipmap.webp", zoom: "shipmap-zoom.webp", chartId: ["connection"] },
    ...
    },
    {
        ...
        img: { full: "rhythm-food.webp", zoom: "rhythm-food.webp", chartId: ["heatmap"] },
    ...
    },
    {
        ...
        img: { full: "state-of-js.webp", zoom: "state-of-js-zoom.webp", chartId: ["connectedScatter"] },
    ...
    },
    {
        ...
        img: { full: "scientific-impact.webp", zoom: "scientific-impact-zoom.webp", chartId: ["line", "ridgeline"] },
    ...
    },
    {
        ...
        img: { full: "rapper-lyrics.webp", zoom: "rapper-lyrics-zoom.webp", chartId: ["scatter", "bubble", "circularPacking"] },
    ...
    },
    {
        ...
        author: "Matthew Daniels",
        url: "https://pudding.cool/projects/vocabulary/index.html",
        img: { full: "rapper-lyrics-2.webp", zoom: "rapper-lyrics-2-zoom.webp", chartId: ["histogram"] },
        contextDescription: "A projects that compares the number of unique words used by some of the most famous artists in hip hop using each artist’s first 35,000 lyrics. Jedi Mind Tricks used 6424 unique words, compared to DMX that counts 2936.",
    ...
    },
    {
        ...
        img: { full: "parent-work.webp", zoom: "parent-work-zoom.webp", chartId: ["histogram"] },
    ...
    },
    {
        ...
        img: { full: "ukraine-attack-leMonde.webp", zoom: "ukraine-attack-leMonde-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "ukraine-migration-nyt.webp", zoom: "ukraine-migration-nyt-zoom.webp", chartId: ["map", "connection"] },
    ...
    },
    {
        ...
        img: { full: "big-mac-price.webp", zoom: "big-mac-price-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        author: "The New York Times",
        url: "https://www.nytimes.com/interactive/2022/world/europe/ukraine-maps.html",
        img: { full: "rouble-tumbles-low.webp", zoom: "rouble-tumbles-low-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "household.webp", zoom: "household-zoom.webp", chartId: ["area"] },
    ...
    },
    {
        ...
        img: { full: "decline-sex.webp", zoom: "decline-sex-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        url: "https://www.washingtonpost.com/business/2019/03/29/share-americans-not-having-sex-has-reached-record-high/",
        img: { full: "student-exchance-europe.webp", zoom: "student-exchance-europe-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "sentiment-russia-twitter.webp", zoom: "sentiment-russia-twitter-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "cat-rescues.webp", zoom: "cat-rescues-zoom.webp", chartId: ["line", "area"] },
    ...
    },
    {
        ...
        img: { full: "world-of-language.webp", zoom: "world-of-language-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        url: "https://www.scmp.com/infographics/article/1810040/infographic-world-languages",
        img: { full: "hong-kong-omicron.webp", zoom: "hong-kong-omicron-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "the Financial Times",
        url: "https://www.scmp.com/infographics/article/1810040/infographic-world-languages",
        img: { full: "hong-kong-omicron-2.webp", zoom: "hong-kong-omicron-zoom-2.webp", chartId: ["line"] },
        contextDescription: "Hong Kong’s vaccination rate has lagged far behind peer countries, especially among the most vulnerable. This article by the financial times goes deep into this matter and compares the situation with other countries.",
    ...
    },
    {
        ...
        img: { full: "switzerland-topography.webp", zoom: "switzerland-topography-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "palmer-penguins.webp", zoom: "palmer-penguins-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "corruption-hdi.webp", zoom: "corruption-hdi-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "penguin-radar.webp", zoom: "penguin-radar-zoom.webp", chartId: ["radar"] },
    ...
    },
    {
        ...
        img: { full: "hiking-washington.webp", zoom: "hiking-washington-zoom.webp", chartId: ["circularBarplot"] },
    ...
    },
    {
        ...
        img: { full: "child-labour.webp", zoom: "child-labour-zoom.webp", chartId: ["line", "area"] },
    ...
    },
    {
        ...
        img: { full: "violin-boxplot-ggplot2.webp", zoom: "violin-boxplot-ggplot2-zoom.webp", chartId: ["violin", "boxplot"] },
    ...
    },
    {
        ...
        img: { full: "vaccine-fda-approval.webp", zoom: "vaccine-fda-approval-zoom.webp", chartId: ["waffle"] },
    ...
    },
    {
        ...
        img: { full: "violin-seaborn.webp", zoom: "violin-seaborn-zoom.webp", chartId: ["violin"] },
    ...
    },
    {
        ...
        img: { full: "revenu-pre-pandemic.webp", zoom: "revenu-pre-pandemic-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "control-of-states.webp", zoom: "control-of-states-zoom.webp", chartId: ["parallel"] },
    ...
    },
    {
        ...
        img: { full: "piano-notes.webp", zoom: "piano-notes-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "art-of-the-high-line.webp", zoom: "art-of-the-high-line-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "carbon-tax.webp", zoom: "carbon-tax-zoom.webp", chartId: [] },
    ...
    },
    {
        ...
        img: { full: "squashing-malaria.webp", zoom: "squashing-malaria-zoom.webp", chartId: ["parallel"] },
    ...
    },
    {
        ...
        img: { full: "cycling-to-work.webp", zoom: "cycling-to-work-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "global-weather-conditions.webp", zoom: "global-weather-conditions-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "wind-map.webp", zoom: "wind-map-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "running-stats.webp", zoom: "running-stats-zoom-1.webp", chartId: ["line", "area", "histogram", "barplot"] },
    ...
    },
    {
        ...
        img: { full: "codebase-viz.webp", zoom: "codebase-viz-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "american-born.webp", zoom: "american-born-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "art-women-posing-1.webp", zoom: "art-women-posing-zoom-1.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        author: "Erin",
        url: "https://erdavis.com/2021/06/14/do-women-who-pose-with-their-art-on-reddit-get-more-upvotes/",
        img: { full: "art-women-posing-2.webp", zoom: "art-women-posing-zoom-2.webp", chartId: ["density"] },
        contextDescription: "Do women who pose with their art on Reddit get more upvotes? Erin gathered reddit data on the topic to proove that yes, posing with your art helps getting upvoted, especially if you're a woman.",
    ...
    },
    {
        ...
        img: { full: "obama-budget-proposal.webp", zoom: "obama-budget-proposal-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "french-presidential-election-1.webp", zoom: "french-presidential-election-zoom-1.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "Le Monde",
        url: "https://www.lemonde.fr/les-decodeurs/article/2022/02/22/presidentielle-2022-le-tableau-de-bord-des-parrainages-sondages-et-temps-de-parole_6114816_4355770.html",
        img: { full: "french-presidential-election-2.webp", zoom: "french-presidential-election-zoom-2.webp", chartId: ["scatter"] },
        contextDescription: "French presidential elections are happening soon. <i>Le Monde</i> wrote a in-depth article showing some of the candidate features: who talks the most on media, who's the richest, who has the best chances to win according to polls?",
    ...
    },
    {
        ...
        author: "Le Monde",
        url: "https://www.lemonde.fr/les-decodeurs/article/2022/02/22/presidentielle-2022-le-tableau-de-bord-des-parrainages-sondages-et-temps-de-parole_6114816_4355770.html",
        img: { full: "french-presidential-election-3.webp", zoom: "french-presidential-election-zoom-3.webp", chartId: ["bubbleMap"] },
        contextDescription: "French presidential elections are happening soon. <i>Le Monde</i> wrote a in-depth article showing some of the candidate features: who talks the most on media, who's the richest, who has the best chances to win according to polls?",
    ...
    },
    {
        ...
        img: { full: "spread-of-qanon-2.webp", zoom: "spread-of-qanon-zoom-2.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "Cédric Scherer",
        url: "https://cemas.io/en/publikationen/q-vadis-the-spread-of-qanon-in-the-german-speaking-world/CeMAS_Q_Vadis_The_Spread_of_QAnon_in_the_German-Speaking_World.pdf",
        img: { full: "spread-of-qanon-3.webp", zoom: "spread-of-qanon-zoom-3.webp", chartId: ["area"] },
        contextDescription: "The central piece of a study on the spread of QAnon in the german-speaking world. It shows the amount of QAnon related messages exchanged on Telegram.",
    ...
    },
    {
        ...
        img: { full: "worst-paid-nba-player.webp", zoom: "worst-paid-nba-player-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "airport-world-megacities-1.webp", zoom: "airport-world-megacities-zoom-1.webp", chartId: ["connection"] },
    ...
    },
    {
        ...
        author: "The Pudding",
        url: "https://pudding.cool/2018/07/airports/",
        img: { full: "airport-world-megacities-2.webp", zoom: "airport-world-megacities-zoom-2.webp", chartId: ["barplot"] },
        contextDescription: "Biggest cities tend to have more departing flights per day. But some cities don't follow the trend. This data-based article tries to explain it.",
    ...
    },
    {
        ...
        author: "The Pudding",
        url: "https://pudding.cool/2018/07/airports/",
        img: { full: "airport-world-megacities-3.webp", zoom: "airport-world-megacities-zoom-3.webp", chartId: ["connectedScatter"] },
        contextDescription: "Biggest cities tend to have more departing flights per day. But some cities don't follow the trend. This data-based article tries to explain it.",
    ...
    },
    {
        ...
        author: "The Pudding",
        url: "https://pudding.cool/2018/07/airports/",
        img: { full: "airport-world-megacities-4.webp", zoom: "airport-world-megacities-zoom-4.webp", chartId: ["scatter"] },
        contextDescription: "Biggest cities tend to have more departing flights per day. But some cities don't follow the trend. This data-based article tries to explain it.",
    ...
    },
    {
        ...
        img: { full: "eating-alone-1.webp", zoom: "eating-alone-zoom-1.webp", chartId: ["scatter", "line"] },
    ...
    },
    {
        ...
        author: "The Pudding",
        url: "https://pudding.cool/2017/07/eating-alone/",
        img: { full: "eating-alone-2.webp", zoom: "eating-alone-zoom-2.webp", chartId: ["lollipop"] },
        contextDescription: "An exploration of the dining habits and companions of Americans.",
    ...
    },
    {
        ...
        img: { full: "rigid-middle-class.webp", zoom: "rigid-middle-class-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "congress-tweeting-1.webp", zoom: "congress-tweeting-zoom-1.webp", chartId: ["barplot", "treemap"] },
    ...
    },
    {
        ...
        author: "The Pudding",
        url: "https://congress.pudding.cool",
        img: { full: "congress-tweeting-2.webp", zoom: "congress-tweeting-zoom-2.webp", chartId: ["area", "line"] },
        contextDescription: "An article describing the topics that dominate members of Congress public discourse.",
    ...
    },
    {
        ...
        author: "The Pudding",
        url: "https://congress.pudding.cool",
        img: { full: "congress-tweeting-3.webp", zoom: "congress-tweeting-zoom-3.webp", chartId: ["hexbin", "map"] },
        contextDescription: "An article describing the topics that dominate members of Congress public discourse.",
    ...
    },
    {
        ...
        img: { full: "switching-phone-1.webp", zoom: "switching-phone-zoom-1.webp", chartId: ["chordDiagram"] },
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://nbremer.github.io/Chord-Diagram-Storytelling/",
        img: { full: "switching-phone-2.webp", zoom: "switching-phone-zoom-2.webp", chartId: ["chordDiagram"] },
        contextDescription: "A study asked 2000 residents of the Netherlands about their mobile phone behavior. The respondents gave information about the brand of their current main phone, and the brand of their previous main phone, and their answers are visualized in this data story.",
    ...
    },
    {
        ...
        img: { full: "satellite-surge.webp", zoom: "satellite-surge-zoom.webp", chartId: ["stream"] },
    ...
    },
    {
        ...
        img: { full: "digital-tracker.webp", zoom: "digital-tracker-zoom.webp", chartId: ["network", "circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "frontex-deportation-1.webp", zoom: "frontex-deportation-zoom-1.webp", chartId: ["connection", "area"] },
    ...
    },
    {
        ...
        img: { full: "shareholder-report-1.webp", zoom: "shareholder-report-zoom-1.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://www.visualcinnamon.com/portfolio/adyen-report-2019/",
        img: { full: "shareholder-report-2.webp", zoom: "shareholder-report-zoom-2.webp", chartId: ["treemap"] },
        contextDescription: "Some figures for a shareholder letter & annual report. Four extensive visuals about the income statement, costs, regional and FTE growth.",
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://www.visualcinnamon.com/portfolio/adyen-report-2019/",
        img: { full: "shareholder-report-3.webp", zoom: "shareholder-report-zoom-3.webp", chartId: ["waffle"] },
        contextDescription: "Some figures for a shareholder letter & annual report. Four extensive visuals about the income statement, costs, regional and FTE growth.",
    ...
    },
    {
        ...
        img: { full: "cultural-heritage.webp", zoom: "cultural-heritage-zoom.webp", chartId: ["network"] },
    ...
    },
    {
        ...
        img: { full: "bussed-out-2.webp", zoom: "bussed-out-zoom-2.webp", chartId: ["bubbleMap"] },
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://www.visualcinnamon.com/portfolio/bussed-out/",
        img: { full: "bussed-out-3.webp", zoom: "bussed-out-zoom-3.webp", chartId: ["arc"] },
        contextDescription: "Each year, US cities give thousands of homeless people one-way bus tickets out of town. An 18-month nationwide investigation by the Guardian reveals, for the first time, what really happens at journey’s end.",
    ...
    },
    {
        ...
        img: { full: "baby-spike.webp", zoom: "baby-spike-zoom.webp", chartId: ["density"] },
    ...
    },
    {
        ...
        img: { full: "lord-of-rings-words.webp", zoom: "lord-of-rings-words-zoom.webp", chartId: ["chordDiagram", "sankey"] },
    ...
    },
    {
        ...
        img: { full: "annual-workinf-hours.webp", zoom: "annual-workinf-hours-zoom.webp", chartId: ["parallel"] },
        contextDescription: "In this visualization you can find out how many words a member of the lord of the rings has spoken at each different location throughout the trilogy.",
    ...
    },
    {
        ...
        img: { full: "fm-radios-map.webp", zoom: "fm-radios-map-zoom.webp", chartId: ["bubbleMap", "map"] },
    ...
    },
    {
        ...
        img: { full: "upvotes-are-beautiful.webp", zoom: "upvotes-are-beautiful-zoom.webp", chartId: ["line", "connectedScatter", "timeseries"] },
    ...
    },
    {
        ...
        img: { full: "hidden-logic-of-cities.webp", zoom: "hidden-logic-of-cities-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "road-intersections.webp", zoom: "road-intersections-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "reading-list.webp", zoom: "reading-list-zoom.webp", chartId: ["line", "timeseries"] },
    ...
    },
    {
        ...
        img: { full: "genome-collection-1.webp", zoom: "genome-collection-zoom-1.webp", chartId: ["dendrogram"] },
    ...
    },
    {
        ...
        author: "Maarten Lambrechts",
        url: "https://www.maartenlambrechts.com/2021/07/02/visualizing-a-genome-collection-with-cactustrees.html",
        img: { full: "genome-collection-2.webp", zoom: "genome-collection-zoom-2.webp", chartId: ["network"] },
        contextDescription: "How do you visualize a genome collection of more than 44.000 soil microbes? A project that takes gene sequences of different kinds of soil organisms, and tries to find species and specimens that are biologically active against crop pests.",
    ...
    },
    {
        ...
        author: "Maarten Lambrechts",
        url: "https://www.maartenlambrechts.com/2021/07/02/visualizing-a-genome-collection-with-cactustrees.html",
        img: { full: "genome-collection-3.webp", zoom: "genome-collection-zoom-3.webp", chartId: ["edgeBundling", "network"] },
        contextDescription: "How do you visualize a genome collection of more than 44.000 soil microbes? A project that takes gene sequences of different kinds of soil organisms, and tries to find species and specimens that are biologically active against crop pests.",
    ...
    },
    {
        ...
        img: { full: "co-autorship-network.webp", zoom: "co-autorship-network-zoom.webp", chartId: ["arc"] },
    ...
    },
    {
        ...
        img: { full: "metal-recovery.webp", zoom: "metal-recovery-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "migration-flow.webp", zoom: "migration-flow-zoom.webp", chartId: ["chordDiagram"] },
    ...
    },
    {
        ...
        img: { full: "eu-regions-1.webp", zoom: "eu-regions-zoom-1.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        author: "Maarten Lambrechts",
        url: "https://pudding.cool/2019/04/eu-regions/",
        img: { full: "eu-regions-2.webp", zoom: "eu-regions-zoom-2.webp", chartId: ["lollipop", "scatter"] },
        contextDescription: "A in-depth analysis of the european regions. It tries to explain why Budapest, Warsaw, and Lithuania split themselves in two.",
    ...
    },
    {
        ...
        img: { full: "animated-treemap.webp", zoom: "animated-treemap-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "eurosearch-song-contest.webp", zoom: "eurosearch-song-contest-zoom.webp", chartId: ["map", "hexbin"] },
    ...
    },
    {
        ...
        img: { full: "the-200-beer-brands.webp", zoom: "the-200-beer-brands-zoom.webp", chartId: ["dendrogram"] },
    ...
    },
    {
        ...
        img: { full: "who-speaks-in-shakespeare.webp", zoom: "who-speaks-in-shakespeare-zoom.webp", chartId: ["stream"] },
    ...
    },
    {
        ...
        img: { full: "mortality-and-mental-disorders-1.webp", zoom: "mortality-and-mental-disorders-zoom-1.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://holtzy.github.io/Mortality/",
        img: { full: "mortality-and-mental-disorders-2.webp", zoom: "mortality-and-mental-disorders-zoom-2.webp", chartId: ["lollipop"] },
        contextDescription: "An interactive webpage that goes along with a <a href='https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(19)32316-5/fulltext'>scientific publication</a>. The goal was to study the links between mortality rates and mental disorders.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://holtzy.github.io/Mortality/",
        img: { full: "mortality-and-mental-disorders-3.webp", zoom: "mortality-and-mental-disorders-zoom-3.webp", chartId: ["barplot"] },
        contextDescription: "An interactive webpage that goes along with a <a href='https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(19)32316-5/fulltext'>scientific publication</a>. The goal was to study the links between mortality rates and mental disorders.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://holtzy.github.io/Mortality/",
        img: { full: "world-mental-health-survey-1.webp", zoom: "world-mental-health-survey-zoom-1.webp", chartId: ["heatmap"] },
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://holtzy.github.io/Mortality/",
        img: { full: "world-mental-health-survey-2.webp", zoom: "world-mental-health-survey-zoom-2.webp", chartId: ["barplot"] },
        contextDescription: "A set of data visualization on comorbidity between mental disorders. This is a webpage that goes along this scientific publication, allowing readers to explore the data themselves.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://holtzy.github.io/Mortality/",
        img: { full: "world-mental-health-survey-3.webp", zoom: "world-mental-health-survey-zoom-3.webp", chartId: ["sankey"] },
        contextDescription: "A set of data visualization on comorbidity between mental disorders. This is a webpage that goes along this scientific publication, allowing readers to explore the data themselves.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://holtzy.github.io/Mortality/",
        img: { full: "world-mental-health-survey-4.webp", zoom: "world-mental-health-survey-zoom-4.webp", chartId: ["line"] },
        contextDescription: "A set of data visualization on comorbidity between mental disorders. This is a webpage that goes along this scientific publication, allowing readers to explore the data themselves.",
    ...
    },
    {
        ...
        img: { full: "end-of-covid-pandemic-1.webp", zoom: "end-of-covid-pandemic-zoom-1.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        author: "Mc Kinsey",
        url: "https://www.mckinsey.com/industries/healthcare-systems-and-services/our-insights/when-will-the-covid-19-pandemic-end",
        img: { full: "end-of-covid-pandemic-2.webp", zoom: "end-of-covid-pandemic-zoom-2.webp", chartId: ["line"] },
        contextDescription: "Mc Kinsey regularly post updates on the covid situation, especially concerning future potential trends. Luckily this report is full of nice visuals.",
    ...
    },
    {
        ...
        author: "Mc Kinsey",
        url: "https://www.mckinsey.com/industries/healthcare-systems-and-services/our-insights/when-will-the-covid-19-pandemic-end",
        img: { full: "end-of-covid-pandemic-3.webp", zoom: "end-of-covid-pandemic-zoom-3.webp", chartId: ["heatmap"] },
        contextDescription: "Mc Kinsey regularly post updates on the covid situation, especially concerning future potential trends. Luckily this report is full of nice visuals.",
    ...
    },
    {
        ...
        author: "Mc Kinsey",
        url: "https://www.mckinsey.com/industries/healthcare-systems-and-services/our-insights/when-will-the-covid-19-pandemic-end",
        img: { full: "end-of-covid-pandemic-4.webp", zoom: "end-of-covid-pandemic-zoom-4.webp", chartId: ["barplot"] },
        contextDescription: "Mc Kinsey regularly post updates on the covid situation, especially concerning future potential trends. Luckily this report is full of nice visuals.",
    ...
    },
    {
        ...
        img: { full: "french-folks-migration.webp", zoom: "french-folks-migration-zoom.webp", chartId: ["map", "connection"] },
    ...
    },
    {
        ...
        img: { full: "transphobic-crimes-sweden.webp", zoom: "transphobic-crimes-sweden-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "the-new-normal-1.webp", zoom: "the-new-normal-zoom-1.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        author: "Alberto Cairo",
        url: "https://public.tableau.com/app/profile/j.lia.borsi5912/viz/VisitVincent/VisitVincent",
        img: { full: "the-new-normal-2.webp", zoom: "the-new-normal-zoom-2.webp", chartId: ["line"] },
        contextDescription: "This visualization uses Google Trends to explore shopping interest for various products before and during the Covid-19 pandemic.",
    ...
    },
    {
        ...
        author: "Alberto Cairo",
        url: "https://public.tableau.com/app/profile/j.lia.borsi5912/viz/VisitVincent/VisitVincent",
        img: { full: "the-new-normal-3.webp", zoom: "the-new-normal-zoom-3.webp", chartId: ["line"] },
        contextDescription: "This visualization uses Google Trends to explore shopping interest for various products before and during the Covid-19 pandemic.",
    ...
    },
    {
        ...
        img: { full: "orion-figma-template-1.webp", zoom: "orion-figma-template-zoom-1.webp", chartId: ["radar"] },
    ...
    },
    {
        ...
        author: "Orion team",
        url: "https://setproduct.com/orion/templates",
        img: { full: "orion-figma-template-2.webp", zoom: "orion-figma-template-zoom-2.webp", chartId: ["circularPacking"] },
        contextDescription: "Orion is a Figma plugin to quickly embed chart templates into a design system.",
    ...
    },
    {
        ...
        img: { full: "league-of-legends-analytics-1.webp", zoom: "league-of-legends-analytics-zoom-1.webp", chartId: ["radar"] },
    ...
    },
    {
        ...
        author: "Kris Akerstrom",
        url: "http://akerstrom.co.uk/league-of-legends-analytics-dashboard/",
        img: { full: "league-of-legends-analytics-2.webp", zoom: "league-of-legends-analytics-zoom-2.webp", chartId: ["barplot"] },
        contextDescription: "An analytics dashboard design to show your stats and help you improve at League of Legends.",
    ...
    },
    {
        ...
        img: { full: "dynamic-planning-1.webp", zoom: "dynamic-planning-zoom-1.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "César Neri",
        url: "https://cesarneri.com/pages/dynamicPlanning.html",
        img: { full: "dynamic-planning-2.webp", zoom: "dynamic-planning-zoom-2.webp", chartId: ["radar"] },
        contextDescription: "Dynamic Planning is a proof of concept for a SaaS planning platform that allows for data-driven decisions based on live building occupancy. In its current state, it is a data visualization dashboard that connects sensor data and institutional datasets to a building information model (BIM) in order to track an organization's planning goals.",
    ...
    },
    {
        ...
        img: { full: "fifty-billions-birds.webp", zoom: "fifty-billions-birds-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        author: "Léa Desrayaud",
        url: "https://www.epsiloon.com",
        img: { full: "marine-biomass.webp", zoom: "marine-biomass-zoom.webp", chartId: ["circularBarplot", 'histogram'] },
    ...
    },
    {
        ...
        author: "Léa Desrayaud",
        url: "https://www.epsiloon.com",
        img: { full: "microbiota-big-cities.webp", zoom: "microbiota-big-cities-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        author: "Léa Desrayaud",
        url: "https://www.epsiloon.com",
        img: { full: "cancer-mammals.webp", zoom: "cancer-mammals-zoom.webp", chartId: ["dendrogram"] },
    ...
    },
    {
        ...
        img: { full: "what-kills-who-got.webp", zoom: "what-kills-who-got-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "1M-covid-deaths.webp", zoom: "1M-covid-deaths-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "global-carbon-footprint.webp", zoom: "global-carbon-footprint-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "madagascar-relief-map.webp", zoom: "madagascar-relief-map-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        author: "@researchremora",
        url: "https://twitter.com/researchremora/status/1527361112022593538",
        img: { full: "madagascar-relief-map-2.webp", zoom: "madagascar-relief-map-2-zoom.webp", chartId: ["map"] },
        contextDescription: "Part of a project called '#rayshader adventures, an #rstats tale'. Many countries have their equivalent in the project. It is made with <a href='https://www.rayshader.com'>rayshader</a>, an open source package for producing 2D and 3D data visualizations in R",
    ...
    },
    {
        ...
        img: { full: "how-i-have-spent-my-time-carni.webp", zoom: "how-i-have-spent-my-time-carni-zoom.webp", chartId: ["stream"] },
    ...
    },
    {
        ...
        author: "Carni Klirs",
        url: "https://www.carniklirs.com/project/spare-time-over-a-lifetime",
        img: { full: "world-resources-report-2.webp", zoom: "world-resources-report-2-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        author: "Carni Klirs",
        url: "https://www.carniklirs.com/project/spare-time-over-a-lifetime",
        img: { full: "world-resources-report-3.webp", zoom: "world-resources-report-3-zoom.webp", chartId: ["barplot"] },
        contextDescription: "The <a href='https://research.wri.org/wrr-food'>World Resource Institute</a> (WRI) studies how to create a sustainable food future. It published a final report giving solutions to ensure the world can feed 10 billion people by 2050 in a sustainable way. It contains many great vizs.",
    ...
    },
    {
        ...
        author: "Carni Klirs",
        url: "https://www.carniklirs.com/project/spare-time-over-a-lifetime",
        img: { full: "world-resources-report-4.webp", zoom: "world-resources-report-4-zoom.webp", chartId: ["line"] },
        contextDescription: "The <a href='https://research.wri.org/wrr-food'>World Resource Institute</a> (WRI) studies how to create a sustainable food future. It published a final report giving solutions to ensure the world can feed 10 billion people by 2050 in a sustainable way. It contains many great vizs.",
    ...
    },
    {
        ...
        img: { full: "untitled-ui-1.webp", zoom: "untitled-ui-1-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "untitledUi",
        url: "https://www.untitledui.com",
        img: { full: "untitled-ui-2.webp", zoom: "untitled-ui-2-zoom.webp", chartId: ["line"] },
        contextDescription: "<a href='https://www.untitledui.com'>Untitled UI</a> is the largest UI kit and design system for Figma in the world. Some of its components are dataviz related.",
    ...
    },
    {
        ...
        author: "untitledUi",
        url: "https://www.untitledui.com",
        img: { full: "untitled-ui-3.webp", zoom: "untitled-ui-3-zoom.webp", chartId: ["donut"] },
        contextDescription: "<a href='https://www.untitledui.com'>Untitled UI</a> is the largest UI kit and design system for Figma in the world. Some of its components are dataviz related.",
    ...
    },
    {
        ...
        author: "untitledUi",
        url: "https://www.untitledui.com",
        img: { full: "untitled-ui-4.webp", zoom: "untitled-ui-4-zoom.webp", chartId: ["radar"] },
        contextDescription: "<a href='https://www.untitledui.com'>Untitled UI</a> is the largest UI kit and design system for Figma in the world. Some of its components are dataviz related.",
    ...
    },
    {
        ...
        img: { full: "datylon-1.webp", zoom: "datylon-1-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-2.webp", zoom: "datylon-2-zoom.webp", chartId: ["pie", "donut"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-3.webp", zoom: "datylon-3-zoom.webp", chartId: ["treemap"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-4.webp", zoom: "datylon-4-zoom.webp", chartId: ["donut"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-5.webp", zoom: "datylon-5-zoom.webp", chartId: ["lollipop"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-6.webp", zoom: "datylon-6-zoom.webp", chartId: ["heatmap"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-7.webp", zoom: "datylon-7-zoom.webp", chartId: ["scatter", "bubble"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-8.webp", zoom: "datylon-8-zoom.webp", chartId: ["density"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-9.webp", zoom: "datylon-9-zoom.webp", chartId: ["barplot"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-10.webp", zoom: "datylon-10-zoom.webp", chartId: ["heatmap"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-11.webp", zoom: "datylon-11-zoom.webp", chartId: ["lollipop"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-12.webp", zoom: "datylon-12-zoom.webp", chartId: ["circularBarplot"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-13.webp", zoom: "datylon-13-zoom.webp", chartId: ["treemap"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-14.webp", zoom: "datylon-14-zoom.webp", chartId: ["ridgeline"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-15.webp", zoom: "datylon-15-zoom.webp", chartId: ["parallel"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-16.webp", zoom: "datylon-16-zoom.webp", chartId: ["connectedScatter"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        author: "Datylon",
        url: "https://insights.datylon.com/stories",
        img: { full: "datylon-17.webp", zoom: "datylon-17-zoom.webp", chartId: ["stream"] },
        contextDescription: "Datylon is a data visualization platform dedicated to graphic designers and report designers who work with <b>Adobe Illustrator</b>. It is a robust chart maker plugin for Illustrator to create beautiful charts and graphs for inspiring data stories.",
    ...
    },
    {
        ...
        img: { full: "individual-carbon-footprint.webp", zoom: "individual-carbon-footprint-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "0-points-to-go.webp", zoom: "0-points-to-go-zoom.webp", chartId: ["heatmap", "timeseries"] },
    ...
    },
    {
        ...
        img: { full: "color-dodge.webp", zoom: "color-dodge-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "bruxelle-malade-2.webp", zoom: "bruxelle-malade-zoom-2.webp", chartId: ["map", "bubbleMap"] },
    ...
    },
    {
        ...
        author: "Catherine Joie et al.",
        url: "https://bxl-malade.medor.coop",
        img: { full: "bruxelle-malade-3.webp", zoom: "bruxelle-malade-zoom-3.webp", chartId: ["circularPacking", "bubble"] },
        contextDescription: "A scrollytelling article (in french) that talks about health in Bruxelles, the capital of Belgium. It highlights the discrepencies that exist between suburbs. A in-depth investigation definitely worth a read.",
    ...
    },
    {
        ...
        author: "Catherine Joie et al.",
        url: "https://bxl-malade.medor.coop",
        img: { full: "bruxelle-malade-4.webp", zoom: "bruxelle-malade-zoom-4.webp", chartId: ["scatter", "bubble"] },
        contextDescription: "A scrollytelling article (in french) that talks about health in Bruxelles, the capital of Belgium. It highlights the discrepencies that exist between suburbs. A in-depth investigation definitely worth a read.",
    ...
    },
    {
        ...
        author: "Catherine Joie et al.",
        url: "https://bxl-malade.medor.coop",
        img: { full: "bruxelle-malade-5.webp", zoom: "bruxelle-malade-zoom-5.webp", chartId: ["heatmap"] },
        contextDescription: "A scrollytelling article (in french) that talks about health in Bruxelles, the capital of Belgium. It highlights the discrepencies that exist between suburbs. A in-depth investigation definitely worth a read.",
    ...
    },
    {
        ...
        author: "Catherine Joie et al.",
        url: "https://bxl-malade.medor.coop",
        img: { full: "bruxelle-malade-6.webp", zoom: "bruxelle-malade-zoom-6.webp", chartId: ["lollipop"] },
        contextDescription: "A scrollytelling article (in french) that talks about health in Bruxelles, the capital of Belgium. It highlights the discrepencies that exist between suburbs. A in-depth investigation definitely worth a read.",
    ...
    },
    {
        ...
        author: "Catherine Joie et al.",
        url: "https://bxl-malade.medor.coop",
        img: { full: "bruxelle-malade-7.webp", zoom: "bruxelle-malade-zoom-7.webp", chartId: ["cartogram", "map"] },
        contextDescription: "A scrollytelling article (in french) that talks about health in Bruxelles, the capital of Belgium. It highlights the discrepencies that exist between suburbs. A in-depth investigation definitely worth a read.",
    ...
    },
    {
        ...
        author: "Catherine Joie et al.",
        url: "https://bxl-malade.medor.coop",
        img: { full: "bruxelle-malade-8.webp", zoom: "bruxelle-malade-zoom-8.webp", chartId: ["parallel"] },
        contextDescription: "A scrollytelling article (in french) that talks about health in Bruxelles, the capital of Belgium. It highlights the discrepencies that exist between suburbs. A in-depth investigation definitely worth a read.",
    ...
    },
    {
        ...
        img: { full: "what-is-wikipedia-about.webp", zoom: "what-is-wikipedia-about-zoom.webp", chartId: ["dendrogram", "bubble"] },
    ...
    },
    {
        ...
        img: { full: "seaborn-pairplot-function.webp", zoom: "seaborn-pairplot-function-zoom.webp", chartId: ["correlogram"] },
    ...
    },
    {
        ...
        img: { full: "correlograms-with-R-1.webp", zoom: "correlograms-with-R-zoom-1.webp", chartId: ["correlogram"] },
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://r-graph-gallery.com/correlogram.html",
        img: { full: "correlograms-with-R-2.webp", zoom: "correlograms-with-R-zoom-2.webp", chartId: ["correlogram"] },
        contextDescription: "An overview of what <a href='https://r-graph-gallery.com/correlogram.html'>R</a> can provide when it comes to build correlograms.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://r-graph-gallery.com/correlogram.html",
        img: { full: "correlograms-with-R-3.webp", zoom: "correlograms-with-R-zoom-3.webp", chartId: ["correlogram"] },
        contextDescription: "An overview of what <a href='https://r-graph-gallery.com/correlogram.html'>R</a> can provide when it comes to build correlograms.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://r-graph-gallery.com/correlogram.html",
        img: { full: "correlograms-with-R-4.webp", zoom: "correlograms-with-R-zoom-4.webp", chartId: ["correlogram"] },
        contextDescription: "An overview of what <a href='https://r-graph-gallery.com/correlogram.html'>R</a> can provide when it comes to build correlograms.",
    ...
    },
    {
        ...
        author: "Yan Holtz",
        url: "https://r-graph-gallery.com/correlogram.html",
        img: { full: "correlograms-with-R-5.webp", zoom: "correlograms-with-R-zoom-5.webp", chartId: ["correlogram"] },
        contextDescription: "An overview of what <a href='https://r-graph-gallery.com/correlogram.html'>R</a> can provide when it comes to build correlograms.",
    ...
    },
    {
        ...
        img: { full: "plastic-waste-1.webp", zoom: "plastic-waste-zoom-1.webp", chartId: ["circularBarplot"] },
    ...
    },
    {
        ...
        author: "Lisa Hornung",
        url: "https://inside-numbers.com/six-things-i-learned-by-tracking-my-plastic-waste-everyday-in-2021",
        img: { full: "plastic-waste-2.webp", zoom: "plastic-waste-zoom-2.webp", chartId: ["heatmap"] },
        contextDescription: "Lisa tracked her plastic waste details for a year and wrote a blogpost full of insightful dataviz to explain the result.",
    ...
    },
    {
        ...
        author: "Lisa Hornung",
        url: "https://inside-numbers.com/six-things-i-learned-by-tracking-my-plastic-waste-everyday-in-2021",
        img: { full: "plastic-waste-3.webp", zoom: "plastic-waste-zoom-3.webp", chartId: ["bubble"] },
        contextDescription: "Lisa tracked her plastic waste details for a year and wrote a blogpost full of insightful dataviz to explain the result.",
    ...
    },
    {
        ...
        author: "Lisa Hornung",
        url: "https://inside-numbers.com/six-things-i-learned-by-tracking-my-plastic-waste-everyday-in-2021",
        img: { full: "plastic-waste-4.webp", zoom: "plastic-waste-zoom-4.webp", chartId: ["barplot"] },
        contextDescription: "Lisa tracked her plastic waste details for a year and wrote a blogpost full of insightful dataviz to explain the result.",
    ...
    },
    {
        ...
        img: { full: "rude-compounds.webp", zoom: "rude-compounds-zoom.webp", chartId: ["heatmap"] },
    ...
    },
    {
        ...
        img: { full: "drag-race.webp", zoom: "drag-race-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "windguru.webp", zoom: "windguru-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "generative-thi-ng.webp", zoom: "generative-thi-ng-zoom.webp", chartId: ["network"] },
    ...
    },
    {
        ...
        img: { full: "what-it-takes-to-space.webp", zoom: "what-it-takes-to-space-zoom.webp", chartId: ["network"] },
    ...
    },
    {
        ...
        img: { full: "fiction-user-interface.webp", zoom: "fiction-user-interface-zoom.webp", chartId: ["network", "barplot", "sankey", "line"] },
    ...
    },
    {
        ...
        img: { full: "wave-of-interest-1.webp", zoom: "wave-of-interest-1-zoom.webp", chartId: ["density2d"] },
    ...
    },
    {
        ...
        author: "Moritz Stefaner",
        url: "https://truth-and-beauty.net/projects/waves-of-interest",
        img: { full: "wave-of-interest-2.webp", zoom: "wave-of-interest-2-zoom.webp", chartId: ["line"] },
        contextDescription: "Which topics capture the attention of Americans during US election years? And how have our interests shifted from one election cycle to the next? This project investigates these questions with the help of Google Search Trends data.",
    ...
    },
    {
        ...
        author: "Moritz Stefaner",
        url: "https://truth-and-beauty.net/projects/waves-of-interest",
        img: { full: "wave-of-interest-3.webp", zoom: "wave-of-interest-3-zoom.webp", chartId: ["connectedScatter"] },
        contextDescription: "Which topics capture the attention of Americans during US election years? And how have our interests shifted from one election cycle to the next? This project investigates these questions with the help of Google Search Trends data.",
    ...
    },
    {
        ...
        img: { full: "serena-williams.webp", zoom: "serena-williams-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "leonardo-dicaprio-girlfriends.webp", zoom: "leonardo-dicaprio-girlfriends-zoom.webp", chartId: ["line", "barplot"] },
    ...
    },
    {
        ...
        img: { full: "shape-happiness.webp", zoom: "shape-happiness-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "europe-gaz-reserves.webp", zoom: "europe-gaz-reserves-zoom.webp", chartId: ["marimekko"] },
    ...
    },
    {
        ...
        img: { full: "economy-and-co2.webp", zoom: "economy-and-co2-zoom.webp", chartId: ["line", "timeseries", "parallel"] },
    ...
    },
    {
        ...
        img: { full: "french-salaries.webp", zoom: "french-salaries-zoom.webp", chartId: ["histogram", "barplot"] },
    ...
    },
    {
        ...
        img: { full: "climat-change-co2-vulnerability.webp", zoom: "climat-change-co2-vulnerability-zoom.webp", chartId: ["scatter", "bubble"] },
    ...
    },
    {
        ...
        img: { full: "britain-ends-coal-addiction.webp", zoom: "britain-ends-coal-addiction-zoom.webp", chartId: ["area", "stackedArea"] },
    ...
    },
    {
        ...
        author: "Financial Times",
        url: "https://www.ft.com/content/a05d1dd4-dddd-11e9-9743-db5a370481bc",
        img: { full: "britain-ends-coal-addiction-2.webp", zoom: "britain-ends-coal-addiction-zoom-2.webp", chartId: ["barplot"] },
        contextDescription: "The shift in the UK is an important victory for environmentalists in their fight against fossil fuels.",
    ...
    },
    {
        ...
        author: "Financial Times",
        url: "https://www.ft.com/content/a05d1dd4-dddd-11e9-9743-db5a370481bc",
        img: { full: "avs-21-reform.webp", zoom: "avs-21-reform-zoom.webp", chartId: ["beeswarm"] },
    ...
    },
    {
        ...
        img: { full: "tree-species-germany.webp", zoom: "tree-species-germany-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "endangered-languages.webp", zoom: "endangered-languages-zoom.webp", chartId: ["barplot", "stream"] },
    ...
    },
    {
        ...
        img: { full: "carbon-emissions.webp", zoom: "carbon-emissions-zoom.webp", chartId: ["circularBarplot"] },
    ...
    },
    {
        ...
        img: { full: "hate-crime-uk.webp", zoom: "hate-crime-uk-zoom.webp", chartId: ["waffle"] },
    ...
    },
    {
        ...
        img: { full: "brazilian-economy-and-inequality.webp", zoom: "brazilian-economy-and-inequality-zoom.webp", chartId: ["connectedScatter"] },
    ...
    },
    {
        ...
        img: { full: "the-slow-loss-2.webp", zoom: "the-slow-loss-zoom-2.webp", chartId: ["dendrogram"] },
    ...
    },
    {
        ...
        img: { full: "number-of-elizabeth.webp", zoom: "number-of-elizabeth-zoom.webp", chartId: ["timeseries"] },
    ...
    },
    {
        ...
        img: { full: "NYT-best-sellers.webp", zoom: "NYT-best-sellers-zoom.webp", chartId: ["table"] },
    ...
    },
    {
        ...
        img: { full: "climate-and-conflicts-1.webp", zoom: "climate-and-conflicts-1-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        author: "Thomas Mayer",
        url: "https://climate-conflict.org",
        img: { full: "climate-and-conflicts-2.webp", zoom: "climate-and-conflicts-2-zoom.webp", chartId: ["bubbleMap"] },
        contextDescription: "What is the relation between climate change and violent conflicts? Which role do socio-economic scope conditions play in exacerbating climate impact? How can we allow analysts and policymaker to make better decisions — based on heterogenous, multi-faceted information sources?",
    ...
    },
    {
        ...
        img: { full: "all-you-need-is-love.webp", zoom: "all-you-need-is-love-zoom.webp", chartId: ["circularBarplot", 'bubble'] },
    ...
    },
    {
        ...
        img: { full: "ebb-and-flow.webp", zoom: "ebb-and-flow-zoom.webp", chartId: ["sankey", 'stream'] },
    ...
    },
    {
        ...
        img: { full: "europe-gaz-dependency.webp", zoom: "europe-gaz-dependency-zoom.webp", chartId: ["cartogram"] },
    ...
    },
    {
        ...
        img: { full: "how-far-by-train.webp", zoom: "how-far-by-train-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "how-britain-voted-1.webp", zoom: "how-britain-voted-1-zoom.webp", chartId: ["choropleth"] },
    ...
    },
    {
        ...
        author: "Gregor Aisch",
        url: "https://driven-by-data.net/2017/06/08/how-britain-voted.html",
        img: { full: "how-britain-voted-2.webp", zoom: "how-britain-voted-2-zoom.webp", chartId: ["cartogram"] },
        contextDescription: "Checking who voted for what in Britain's election.",
    ...
    },
    {
        ...
        img: { full: "nation-compromised-by-terrorism.webp", zoom: "nation-compromised-by-terrorism-zoom.webp", chartId: ["cartogram"] },
    ...
    },
    {
        ...
        img: { full: "billionaire-boom.webp", zoom: "billionaire-boom-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        author: "Financial Times",
        url: "https://www.ft.com/content/747a76dd-f018-4d0d-a9f3-4069bf2f5a93",
        img: { full: "billionaire-boom-2.webp", zoom: "billionaire-boom-zoom-2.webp", chartId: ["area"] },
        contextDescription: "Pandemic stimulus has made the world’s wealthiest wealthier. Ruchir Sharma charts the rise of ‘good’ and ‘bad’ billionaires around the world",
    ...
    },
    {
        ...
        author: "Financial Times",
        url: "https://www.ft.com/content/747a76dd-f018-4d0d-a9f3-4069bf2f5a93",
        img: { full: "billionaire-boom-3.webp", zoom: "billionaire-boom-zoom-3.webp", chartId: ["barplot"] },
        contextDescription: "Pandemic stimulus has made the world’s wealthiest wealthier. Ruchir Sharma charts the rise of ‘good’ and ‘bad’ billionaires around the world",
    ...
    },
    {
        ...
        img: { full: "musk-and-followers.webp", zoom: "musk-and-followers-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "My-career-in-a-graph.webp", zoom: "My-career-in-a-graph-zoom.webp", chartId: ["parallel"] },
    ...
    },
    {
        ...
        img: { full: "Pornstars-per-million-inhabitants.webp", zoom: "Pornstars-per-million-inhabitants-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "Plus-petits-noms-communes.webp", zoom: "Plus-petits-noms-communes-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "ChatGPT-vs-Lensa.webp", zoom: "ChatGPT-vs-Lensa-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "Smoking-population-by-country.webp", zoom: "Smoking-population-by-country-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "Population-density-maps.webp", zoom: "Population-density-maps-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "Chinese-repression-via-Twitter.webp", zoom: "Chinese-repression-via-Twitter-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "Indias-unsung-freedom-fighters.webp", zoom: "Indias-unsung-freedom-fighters-zoom.webp", chartId: ["circularBarplot"] },
    ...
    },
    {
        ...
        img: { full: "Population-movements-in-Germany.webp", zoom: "Population-movements-in-Germany-zoom.webp", chartId: ["map", "choropleth", "connection"] },
    ...
    },
    {
        ...
        img: { full: "Biggest-accident-in-history.webp", zoom: "Biggest-accident-in-history-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "Super-Bowl-commercials.webp", zoom: "Super-Bowl-commercials-zoom.webp", chartId: ["stream"] },
    ...
    },
    {
        ...
        img: { full: "Consumer-Confidence-around-the-world.webp", zoom: "Consumer-Confidence-around-the-world-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "The-time-at-which-films-are-born-2.webp", zoom: "The-time-at-which-films-are-born-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "French-legislative-elections.webp", zoom: "French-legislative-elections-zoom.webp", chartId: ["circularPacking", 'barplot', 'voronoi'] },
    ...
    },
    {
        ...
        img: { full: "Who-speaks-about-whom-in-The-Office.webp", zoom: "Who-speaks-about-whom-in-The-Office-zoom.webp", chartId: ["chordDiagram"] },
    ...
    },
    {
        ...
        author: "Dominic Royé",
        url: "https://twitter.com/_ansgar/status/1647905766479732736",
        img: { full: "Wine-oil-fruit-southwestern-Europe.webp", zoom: "Wine-oil-fruit-southwestern-Europe-zoom.webp", chartId: ["map", "bubbleMap", "hexbin"] },
    ...
    },
    {
        ...
        img: { full: "Noise-pollution-commute-1.webp", zoom: "Noise-pollution-commute-1-zoom.webp", chartId: ["bubble", 'line'] },
    ...
    },
    {
        ...
        author: "Ludovic Riffault",
        url: "https://commute.dataveyes.com/",
        img: { full: "Noise-pollution-commute-2.webp", zoom: "Noise-pollution-commute-2-zoom.webp", chartId: ["bubble", 'line'] },
        contextDescription: "Visualisation of the ambient noise during parisian subway journeys, with algorithmically generated melodies.",
        chartDescription: "Pretty hard to describe this chart type as it goes more into data art than data analysis 🙃",
        tools: undefined,
        luminosity: ["dark"],
    ...
    },
    {
        ...
        img: { full: "French-short-haul-flights.webp", zoom: "French-short-haul-flights-zoom.webp", chartId: ["connection"] },
    ...
    },
    {
        ...
        img: { full: "Migrants-searches-and-realities.webp", zoom: "Migrants-searches-and-realities-zoom.webp", chartId: ["stackedArea", "chordDiagram"] },
    ...
    },
    {
        ...
        img: { full: "A-day-in-the-life-of-Americans.webp", zoom: "A-day-in-the-life-of-Americans-zoom.webp", chartId: ["bubble", "network"] },
    ...
    },
    {
        ...
        img: { full: "choropleth-map-with-a-customized-legend.webp", zoom: "choropleth-map-with-a-customized-legend-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "small-multilple-line-chart-unemployment-linecharts.webp", zoom: "small-multilple-line-chart-unemployment-linecharts-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "earthquakes-around-the-world.webp", zoom: "earthquakes-around-the-world-zoom.webp", chartId: ["map", "bubbleMap"] },
    ...
    },
    {
        ...
        img: { full: "evolution-movie-rating.webp", zoom: "evolution-movie-rating-zoom.webp", chartId: ["line", "connectedScatter"] },
    ...
    },
    {
        ...
        img: { full: "evolution-natural-disasters.webp", zoom: "evolution-natural-disasters-zoom.webp", chartId: ["stackedArea"] },
    ...
    },
    {
        ...
        img: { full: "sponsored-projects.webp", zoom: "sponsored-projects-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "hdi-sao-polo.webp", zoom: "hdi-sao-polo-zoom.webp", chartId: ["map", "choropleth", "histogram"] },
    ...
    },
    {
        ...
        img: { full: "lollipop-evolution-global-temperature.webp", zoom: "lollipop-evolution-global-temperature-zoom.webp", chartId: ["lollipop"] },
    ...
    },
    {
        ...
        img: { full: "area-chart-japan-population.webp", zoom: "area-chart-japan-population-zoom.webp", chartId: ["area"] },
    ...
    },
    {
        ...
        img: { full: "two-winters-usa.webp", zoom: "two-winters-usa-zoom.webp", chartId: ["hexbin", "lollipop"] },
    ...
    },
    {
        ...
        img: { full: "infant-death-rates-evolution.webp", zoom: "infant-death-rates-evolution-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "sankey-summer-movies.webp", zoom: "sankey-summer-movies-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "map-waffle-chart-london-recycling.webp", zoom: "map-waffle-chart-london-recycling-zoom.webp", chartId: ["waffle", "map"] },
    ...
    },
    {
        ...
        img: { full: "waffle-share-animal-feeds.webp", zoom: "waffle-share-animal-feeds-zoom.webp", chartId: ["waffle"] },
    ...
    },
    {
        ...
        img: { full: "wellbeing-NYT.webp", zoom: "wellbeing-NYT-zoom.webp", chartId: ["parallel"] },
    ...
    },
    {
        ...
        img: { full: "death-wikipedia-traffic.webp", zoom: "death-wikipedia-traffic-zoom.webp", chartId: ["density", "ridgeline"] },
    ...
    },
    {
        ...
        img: { full: "olympic-medal-NYC.webp", zoom: "olympic-medal-NYC-zoom.webp", chartId: ["stream"] },
    ...
    },
    {
        ...
        img: { full: "alberta-grade.webp", zoom: "alberta-grade-zoom.webp", chartId: ["lollipop", "area"] },
    ...
    },
    {
        ...
        img: { full: "covid-search.webp", zoom: "covid-search-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "inflation-word.webp", zoom: "inflation-word-zoom.webp", chartId: ["wordcloud"] },
    ...
    },
    {
        ...
        img: { full: "electricity-generation.webp", zoom: "electricity-generation-zoom.webp", chartId: ["stackedArea"] },
    ...
    },
    {
        ...
        img: { full: "harvard-grant.webp", zoom: "harvard-grant-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "occupation-age.webp", zoom: "occupation-age-zoom.webp", chartId: ["circularPacking", "barplot"] },
    ...
    },
    {
        ...
        img: { full: "bake-recipe.webp", zoom: "bake-recipe-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "sf-homeless-dendrogram.webp", zoom: "sf-homeless-dendrogram-zoom.webp", chartId: ["dendrogram"] },
    ...
    },
    {
        ...
        author: "Crankstart",
        url: "https://streetstostability.com/today",
        img: { full: "sf-homeless-sankey.webp", zoom: "sf-homeless-sankey-zoom.webp", chartId: ["sankey"] },
        contextDescription: "A report by Crankstart, a San Francisco'based family foundation, addresses San Francisco's homelessness and offers a road map for administrations to build a better system with demonstrable results.",
    ...
    },
    {
        ...
        img: { full: "lifespan-animal.webp", zoom: "lifespan-animal-zoom.webp", chartId: ["scatter", "bubble"] },
    ...
    },
    {
        ...
        img: { full: "wes-anderson-film.webp", zoom: "wes-anderson-film-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "mail-vote.webp", zoom: "mail-vote-zoom.webp", chartId: ["hexbin"] },
    ...
    },
    {
        ...
        img: { full: "news-story-area.webp", zoom: "news-story-area-zoom.webp", chartId: ["area"] },
    ...
    },
    {
        ...
        author: "Schema Design",
        url: "https://www.newslifespan.com/",
        img: { full: "news-story-map.webp", zoom: "news-story-map-zoom.webp", chartId: ["bubbleMap"] },
        contextDescription: "In collaboration between Schema, Google News Initiative, Alberto Cairo, and Axios, the project analyzes search interest data of the top news stories of 2018.",
    ...
    },
    {
        ...
        img: { full: "cat-inkjet-venn.webp", zoom: "cat-inkjet-venn-zoom.webp", chartId: ["venn"] },
    ...
    },
    {
        ...
        img: { full: "inflation-america.webp", zoom: "inflation-america-zoom.webp", chartId: ["heatmap"] },
    ...
    },
    {
        ...
        img: { full: "anti-tag-wordcloud.webp", zoom: "anti-tag-wordcloud-zoom.webp", chartId: ["wordcloud"] },
    ...
    },
    {
        ...
        img: { full: "employee-review-beeswarm.webp", zoom: "employee-review-beeswarm-zoom.webp", chartId: ["beeswarm", "bubble"] },
    ...
    },
    {
        ...
        author: "The Economist",
        url: "https://www.economist.com/interactive/business/2025/06/16/corporate-culture",
        img: { full: "employee-review-scatter.webp", zoom: "employee-review-scatter-zoom.webp", chartId: ["scatter"] },
        contextDescription: "How do employees rate their company's work-life balance? The Economist, in partnership with CultureX, a research and AI firm, measures corporate culture across 900 firms in 19 industries. The measurement expressed in the graph is divided into four: work-life balance, toxic culture, leadership, and agility.",
    ...
    },
    {
        ...
        img: { full: "shakespeare-word.webp", zoom: "shakespeare-word-zoom.webp", chartId: ["chordDiagram"] },
    ...
    },
    {
        ...
        img: { full: "emotion-venn.webp", zoom: "emotion-venn-zoom.webp", chartId: ["venn"] },
    ...
    },
    {
        ...
        img: { full: "NYT-survey-pie.webp", zoom: "NYT-survey-pie-zoom.webp", chartId: ["pie"] },
    ...
    },
    {
        ...
        img: { full: "american-bmi.webp", zoom: "american-bmi-zoom.webp", chartId: ["bubble", "heatmap", "scatter"] },
    ...
    },
    {
        ...
        img: { full: "nuclear-stream.webp", zoom: "nuclear-stream-zoom.webp", chartId: ["stream", "stackedArea", "area"] },
    ...
    },
    {
        ...
        img: { full: "EU-economy-slope.webp", zoom: "EU-economy-slope-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://data.europa.eu/en/publications/datastories/promising-horizon-how-2025-2027-horizon-europe-strategic-plan-will-shape",
        img: { full: "EU-economy-map.webp", zoom: "EU-economy-map-zoom.webp", chartId: ["map", "choropleth"] },
        contextDescription: "One of the three EU's Data Stories created by Nadieh Bremer, the first piece explores the 2025-2027 Horizon Europe strategic plan that plans to invest in circular economy, space, and AI.",
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://data.europa.eu/en/publications/datastories/promising-horizon-how-2025-2027-horizon-europe-strategic-plan-will-shape",
        img: { full: "EU-economy-bar.webp", zoom: "EU-economy-bar-zoom.webp", chartId: ["barplot"] },
        contextDescription: "One of the three EU's Data Stories created by Nadieh Bremer, the first piece explores the 2025-2027 Horizon Europe strategic plan that plans to invest in circular economy, space, and AI.",
    ...
    },
    {
        ...
        img: { full: "EU-leisure-circle.webp", zoom: "EU-leisure-circle-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://data.europa.eu/en/publications/datastories/leisure-europe-insights-open-data",
        img: { full: "EU-leisure-circle-two.webp", zoom: "EU-leisure-circle-two-zoom.webp", chartId: ["bubble"] },
        contextDescription: "Second piece for EU's Data Stories, created by Nadieh Bremer, covers leisure, culture and tourism in Europe.",
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://data.europa.eu/en/publications/datastories/leisure-europe-insights-open-data",
        img: { full: "EU-leisure-map.webp", zoom: "EU-leisure-map-zoom.webp", chartId: ["map", "choropleth"] },
        contextDescription: "Second piece for EU's Data Stories, created by Nadieh Bremer, covers leisure, culture and tourism in Europe.",
    ...
    },
    {
        ...
        img: { full: "EU-healthcare-voronoi1.webp", zoom: "EU-healthcare-voronoi1-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://data.europa.eu/en/publications/datastories/health-and-well-being-eu-investing-where-it-matters",
        img: { full: "EU-healthcare-voronoi2.webp", zoom: "EU-healthcare-voronoi2-zoom.webp", chartId: ["circularPacking"] },
        contextDescription: "The last piece for the European Union, this project uses open data on healthcare spending to analyze healthcare access throughout the EU.",
    ...
    },
    {
        ...
        author: "Nadieh Bremer",
        url: "https://data.europa.eu/en/publications/datastories/health-and-well-being-eu-investing-where-it-matters",
        img: { full: "EU-healthcare-voronoi3.webp", zoom: "EU-healthcare-voronoi3-zoom.webp", chartId: ["circularPacking"] },
        contextDescription: "The last piece for the European Union, this project uses open data on healthcare spending to analyze healthcare access throughout the EU.",
    ...
    },
    {
        ...
        img: { full: "paris-train-animation.webp", zoom: "paris-train-animation-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "tiktok-users-washingtonpost.webp", zoom: "tiktok-users-washingtonpost-zoom.webp", chartId: ["bubble", "scatter"] },
    ...
    },
    {
        ...
        img: { full: "subway-data-love-letter-sankey.webp", zoom: "subway-data-love-letter-sankey-zoom.webp", chartId: ["sankey", "line"] },
    ...
    },
    {
        ...
        author: "Pentagram & Giorgia Lupi",
        url: "https://www.pentagram.com/work/a-data-love-letter-to-the-subway",
        img: { full: "subway-data-love-letter-barplot.webp", zoom: "subway-data-love-letter-barplot-zoom.webp", chartId: ["barplot", "line", "histogram"] },
        contextDescription: "A data-driven animation for Fulton Center commissioned by MTA Arts & Design for its 40th annivery. Pentagram, in partnership with Giorgia Lupi, uses MTA data to visualize each train line as a character with its unique personality.",
    ...
    },
    {
        ...
        img: { full: "fuel-mix-stacked-area.webp", zoom: "fuel-mix-stacked-area-zoom.webp", chartId: ["area", "stackedArea", "stream"] },
    ...
    },
    {
        ...
        img: { full: "protein-supply-voronoi.webp", zoom: "protein-supply-voronoi-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "carrie-bradshaw-afford.webp", zoom: "carrie-bradshaw-afford-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "map-projection-washington-post.webp", zoom: "map-projection-washington-post-zoom.webp", chartId: ["map", "cartogram"] },
    ...
    },
    {
        ...
        img: { full: "guardian-bird-of-year-2025.webp", zoom: "guardian-bird-of-year-2025-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "guardian-bird-migrate-green.webp", zoom: "guardian-bird-migrate-green-zoom.webp", chartId: ["map", "choropleth", "connection"] },
    ...
    },
    {
        ...
        author: "The Guardian",
        url: "https://www.theguardian.com/environment/ng-interactive/2025/oct/16/bird-migration-is-changing-what-does-this-reveal-about-our-planet-visualised-aoe",
        img: { full: "guardian-bird-migrate-heat.webp", zoom: "guardian-bird-migrate-heat-zoom.webp", chartId: ["map", "choropleth", "connection"] },
        contextDescription: "The Guardian has tracked bird migration via GPS data. Using animation and map charts, the article explains how climate change has impacted bird travel.",
    ...
    },
    {
        ...
        author: "The Guardian",
        url: "https://www.theguardian.com/environment/ng-interactive/2025/oct/16/bird-migration-is-changing-what-does-this-reveal-about-our-planet-visualised-aoe",
        img: { full: "guardian-bird-mario-migrate.webp", zoom: "guardian-bird-mario-migrate-zoom.webp", chartId: ["map", "choropleth", "connection"] },
        contextDescription: "The Guardian has tracked bird migration via GPS data. Using animation and map charts, the article explains how climate change has impacted bird travel.",
    ...
    },
    {
        ...
        img: { full: "food-insecurity-women-tidytuesday.webp", zoom: "food-insecurity-women-tidytuesday-zoom.webp", chartId: ["barplot", "histogram"] },
    ...
    },
    {
        ...
        img: { full: "economic-barcode-inflation.webp", zoom: "economic-barcode-inflation-zoom.webp", chartId: ["barplot", "histogram", "line"] },
    ...
    },
    {
        ...
        img: { full: "repair-cafe-success-rate.webp", zoom: "repair-cafe-success-rate-zoom.webp", chartId: ["bubble", "scatter"] },
    ...
    },
    {
        ...
        img: { full: "diet-meat-region-impact.webp", zoom: "diet-meat-region-impact-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "china-rare-earth-area.webp", zoom: "china-rare-earth-area-zoom.webp", chartId: ["area", "stackedArea"] },
    ...
    },
    {
        ...
        author: "The Economist",
        url: "https://www.economist.com/interactive/briefing/2025/08/13/chinas-power-over-rare-earths-is-not-as-great-as-it-seems",
        img: { full: "china-rare-earth-sankey.webp", zoom: "china-rare-earth-sankey-zoom.webp", chartId: ["sankey"] },
        contextDescription: "An interactive article by The Economist explains in-depth of the recent global tension over rare earth minerals.",
    ...
    },
    {
        ...
        author: "The Economist",
        url: "https://www.economist.com/interactive/briefing/2025/08/13/chinas-power-over-rare-earths-is-not-as-great-as-it-seems",
        img: { full: "china-rare-earth-map.webp", zoom: "china-rare-earth-map-zoom.webp", chartId: ["map", "bubbleMap"] },
        contextDescription: "An interactive article by The Economist explains in-depth of the recent global tension over rare earth minerals.",
    ...
    },
    {
        ...
        img: { full: "middle-income-state.webp", zoom: "middle-income-state-zoom.webp", chartId: ["lollipop"] },
    ...
    },
    {
        ...
        img: { full: "nadieh-bremer-pesticide.webp", zoom: "nadieh-bremer-pesticide-zoom.webp", chartId: ["voronoi", "treemap"] },
    ...
    },
    {
        ...
        img: { full: "guardian-lego-chart.webp", zoom: "guardian-lego-chart-zoom.webp", chartId: ["histogram", "barplot"] },
    ...
    },
    {
        ...
        img: { full: "annual-rainfall-30daymap.webp", zoom: "annual-rainfall-30daymap-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "the-pudding-democracy.webp", zoom: "the-pudding-democracy-zoom.webp", chartId: ["barplot", "scatter", "histogram"] },
    ...
    },
    {
        ...
        img: { full: "brussell-voronoi-treemap.webp", zoom: "brussell-voronoi-treemap-zoom.webp", chartId: ["voronoi", "treemap"] },
    ...
    },
    {
        ...
        author: "Karim Douieb",
        url: "https://brussels-diversity.jetpack.ai/",
        img: { full: "brussell-map.webp", zoom: "brussell-map-zoom.webp", chartId: ["map"] },
        contextDescription: "A data viz essay exploring Brussels and its people.",
    ...
    },
    {
        ...
        img: { full: "global-economy-by-gdp.webp", zoom: "global-economy-by-gdp-zoom.webp", chartId: ["voronoi", "treemap"] },
    ...
    },
    {
        ...
        img: { full: "EU-AU-relation-choropleth-1.webp", zoom: "EU-AU-relation-choropleth-1-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        author: "European Union Institute for Security Studies (EUISS)",
        url: "https://www.iss.europa.eu/sites/default/files/EUISSFiles/CP_180_screen_small.pdf",
        img: { full: "EU-AU-relation-choropleth-2.webp", zoom: "EU-AU-relation-choropleth-2-zoom.webp", chartId: ["map", "choropleth"] },
        contextDescription: "In partnership between the European Union (EU) and the African Union (AU), The European Union Institute for Security Studies published a data-heavy report on EU-AU relations.",
    ...
    },
    {
        ...
        author: "European Union Institute for Security Studies (EUISS)",
        url: "https://www.iss.europa.eu/sites/default/files/EUISSFiles/CP_180_screen_small.pdf",
        img: { full: "EU-AU-relation-treemap.webp", zoom: "EU-AU-relation-treemap-zoom.webp", chartId: ["treemap"] },
        contextDescription: "In partnership between the European Union (EU) and the African Union (AU), The European Union Institute for Security Studies published a data-heavy report on EU-AU relations.",
    ...
    },
    {
        ...
        author: "European Union Institute for Security Studies (EUISS)",
        url: "https://www.iss.europa.eu/sites/default/files/EUISSFiles/CP_180_screen_small.pdf",
        img: { full: "EU-AU-relation-heatmap.webp", zoom: "EU-AU-relation-heatmap-zoom.webp", chartId: ["heatmap"] },
        contextDescription: "In partnership between the European Union (EU) and the African Union (AU), The European Union Institute for Security Studies published a data-heavy report on EU-AU relations.",
    ...
    },
    {
        ...
        author: "European Union Institute for Security Studies (EUISS)",
        url: "https://www.iss.europa.eu/sites/default/files/EUISSFiles/CP_180_screen_small.pdf",
        img: { full: "EU-AU-relation-line-1.webp", zoom: "EU-AU-relation-line-1-zoom.webp", chartId: ["line"] },
        contextDescription: "In partnership between the European Union (EU) and the African Union (AU), The European Union Institute for Security Studies published a data-heavy report on EU-AU relations.",
    ...
    },
    {
        ...
        author: "European Union Institute for Security Studies (EUISS)",
        url: "https://www.iss.europa.eu/sites/default/files/EUISSFiles/CP_180_screen_small.pdf",
        img: { full: "EU-AU-relation-connnected-dot-1.webp", zoom: "EU-AU-relation-connnected-dot-1-zoom.webp", chartId: ["connectedScatter"] },
        contextDescription: "In partnership between the European Union (EU) and the African Union (AU), The European Union Institute for Security Studies published a data-heavy report on EU-AU relations.",
    ...
    },
    {
        ...
        author: "European Union Institute for Security Studies (EUISS)",
        url: "https://www.iss.europa.eu/sites/default/files/EUISSFiles/CP_180_screen_small.pdf",
        img: { full: "EU-AU-relation-correlogram-1.webp", zoom: "EU-AU-relation-correlogram-1-zoom.webp", chartId: ["correlogram"] },
        contextDescription: "In partnership between the European Union (EU) and the African Union (AU), The European Union Institute for Security Studies published a data-heavy report on EU-AU relations.",
    ...
    },
    {
        ...
        img: { full: "passport-index.webp", zoom: "passport-index-zoom.webp", chartId: ["map", "connection"] },
    ...
    },
    {
        ...
        img: { full: "spina-bifida-half-circle.webp", zoom: "spina-bifida-half-circle-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "chocolate-war-radar.webp", zoom: "chocolate-war-radar-zoom.webp", chartId: ["radar"] },
    ...
    },
    {
        ...
        author: "Surbhi Bhatia",
        url: "https://surbhi-bh.github.io/chocolate-wars/",
        img: { full: "chocolate-war-barplot.webp", zoom: "chocolate-war-barplot-zoom.webp", chartId: ["barplot"] },
        contextDescription: "Does U.S. chocolate taste poorly compared to the same ones produced in Europe? Surbhi Bhatia uses data of each chocolate ingredients to find it out.",
    ...
    },
    {
        ...
        img: { full: "germany-youth-hexbin.webp", zoom: "germany-youth-hexbin-zoom.webp", chartId: ["map", "hexbin"] },
    ...
    },
    {
        ...
        img: { full: "france-train-car.webp", zoom: "france-train-car-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "carbon-footprint-radar.webp", zoom: "carbon-footprint-radar-zoom.webp", chartId: ["radar"] },
    ...
    },
    {
        ...
        img: { full: "consciousness-ft-line.webp", zoom: "consciousness-ft-line-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "ACT-threatened-species.webp", zoom: "ACT-threatened-species-zoom.webp", chartId: ["dendrogram"] },
    ...
    },
    {
        ...
        img: { full: "tiktok-algorithm-wp.webp", zoom: "tiktok-algorithm-wp-zoom.webp", chartId: ["map", "hexbin"] },
    ...
    },
    {
        ...
        img: { full: "kpop-physical-album.webp", zoom: "kpop-physical-album-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "defense-company-reuters.webp", zoom: "defense-company-reuters-zoom.webp", chartId: ["circularPacking"] },
    ...
    },
    {
        ...
        img: { full: "2025-US-snow-map.webp", zoom: "2025-US-snow-map-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "who-earns-higher-salary-nathan-yau.webp", zoom: "who-earns-higher-salary-nathan-yau-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "AI-investment-reuters.webp", zoom: "AI-investment-reuters-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "coffee-straits-times.webp", zoom: "coffee-straits-times-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "france-rent-2025.webp", zoom: "france-rent-2025-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "ft-chinese-import-tariff.webp", zoom: "ft-chinese-import-tariff-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "horror-word-pumpkin.webp", zoom: "horror-word-pumpkin-zoom.webp", chartId: ["wordcloud"] },
    ...
    },
    {
        ...
        img: { full: "instagram-rich-list.webp", zoom: "instagram-rich-list-zoom.webp", chartId: ["bubble"] },
    ...
    },
    {
        ...
        img: { full: "haiti-migrant-map.webp", zoom: "haiti-migrant-map-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "volcanoe-eruptions.webp", zoom: "volcanoe-eruptions-zoom.webp", chartId: ["sankey", "line"] },
    ...
    },
    {
        ...
        img: { full: "circular-barplot-white-christmas.webp", zoom: "circular-barplot-white-christmas-zoom.webp", chartId: ["circularBarplot"] },
    ...
    },
    {
        ...
        img: { full: "crime-asset-stream.webp", zoom: "crime-asset-stream-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "amusement-park-north-america.webp", zoom: "amusement-park-north-america-zoom.webp", chartId: ["map", "bubbleMap"] },
    ...
    },
    {
        ...
        img: { full: "loneliness-income-the-economist.webp", zoom: "loneliness-income-the-economist-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "drinking-slang-word-the-economist.webp", zoom: "drinking-slang-word-the-economist-zoom.webp", chartId: ["wordcloud"] },
    ...
    },
    {
        ...
        img: { full: "American-religion-pew-research.webp", zoom: "American-religion-pew-research-zoom.webp", chartId: ["pie"] },
    ...
    },
    {
        ...
        img: { full: "celebrate-winter-solstice.webp", zoom: "celebrate-winter-solstice-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "AI-data-center-bloomberg.webp", zoom: "AI-data-center-bloomberg-zoom.webp", chartId: ["map", "bubbleMap"] },
    ...
    },
    {
        ...
        img: { full: "time-with-others-nathan-yau.webp", zoom: "time-with-others-nathan-yau-zoom.webp", chartId: ["ridgeline"] },
    ...
    },
    {
        ...
        img: { full: "ICE-deport-ny-times.webp", zoom: "ICE-deport-ny-times-zoom.webp", chartId: ["connection", "map"] },
    ...
    },
    {
        ...
        img: { full: "lego-USA-today.webp", zoom: "lego-USA-today-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "born-again-life-change.webp", zoom: "born-again-life-change-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "texas-tribune-income-college.webp", zoom: "texas-tribune-income-college-zoom.webp", chartId: ["sankey"] },
    ...
    },
    {
        ...
        img: { full: "france-2024-election-le-monde.webp", zoom: "france-2024-election-le-monde-zoom.webp", chartId: ["map", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "country-population-voronoi-treemap.webp", zoom: "country-population-voronoi-treemap-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "ukraine-damage-map-the-new-york-times.webp", zoom: "ukraine-damage-map-the-new-york-times-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "french-election-2024-karim-douieb.webp", zoom: "french-election-2024-karim-douieb-zoom.webp", chartId: [] },
    ...
    },
    {
        ...
        img: { full: "forest-fire-voronoi-treemap.webp", zoom: "forest-fire-voronoi-treemap-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "elon-musk-tweet-les-echos.webp", zoom: "elon-musk-tweet-les-echos-zoom.webp", chartId: ["line"] },
    ...
    },
    {
        ...
        img: { full: "company-impact-project-data-art.webp", zoom: "company-impact-project-data-art-zoom.webp", chartId: [] },
    ...
    },
    {
        ...
        img: { full: "git-commit-nadieh-bremer.webp", zoom: "git-commit-nadieh-bremer-zoom.webp", chartId: ["circularPacking"] },
        ...
        chartDescription: "Commits grouped by month, each scaled by the number of lines changed, in an interactive timeline where you can explore a commit and jump to others by the same author. More on <a href='https://www.visualcinnamon.com/portfolio/orca-github-commits/'>her blog</a>.",
    ...
    },
    {
        ...
        img: { full: "europe-wants-kamala-harris-european-correspondent.webp", zoom: "europe-wants-kamala-harris-european-correspondent-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "de-Volkskrant-european-election.webp", zoom: "de-Volkskrant-european-election-zoom.webp", chartId: ["map"] },
    ...
    },
    {
        ...
        img: { full: "afD-hatred-parliament-map.webp", zoom: "afD-hatred-parliament-map-zoom.webp", chartId: ["map", "barplot", "choropleth"] },
    ...
    },
    {
        ...
        img: { full: "big-car-weight-the-economist.webp", zoom: "big-car-weight-the-economist-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "star-trek-voronoi-treemap-tableau.webp", zoom: "star-trek-voronoi-treemap-tableau-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "james-bond-tableau-iron-viz.webp", zoom: "james-bond-tableau-iron-viz-zoom.webp", chartId: ["treemap"] },
    ...
    },
    {
        ...
        img: { full: "education-gdp-connected-scatterplot.webp", zoom: "education-gdp-connected-scatterplot-zoom.webp", chartId: ["connectedScatter"] },
    ...
    },
    {
        ...
        img: { full: "how-europe-is-feeling-european-correspondent.webp", zoom: "how-europe-is-feeling-european-correspondent-zoom.webp", chartId: ["scatter", "beeswarm"] },
    ...
    },
    {
        ...
        img: { full: "hottest-year-2025-the-economist-heatmap.webp", zoom: "hottest-year-2025-the-economist-heatmap-zoom.webp", chartId: ["heatmap"] },
    ...
    },
    {
        ...
        img: { full: "funds-for-ICE-barplot-ny-times.webp", zoom: "funds-for-ICE-barplot-ny-times-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "dog-breed-behavior-scientific-american.webp", zoom: "dog-breed-behavior-scientific-american-zoom.webp", chartId: ["scatter"] },
    ...
    },
    {
        ...
        img: { full: "britain-ethnicity-diverse-segregate-the-economist.webp", zoom: "britain-ethnicity-diverse-segregate-the-economist-zoom.webp", chartId: ["scatter"] },
        contextDescription: "An interactive Economist piece on how diverse England has become, and where. With official figures unavailable, they estimated each area's ethnic make-up from the annual census of schoolchildren. More in <a href='https://theeconomistoffthecharts.substack.com/'>The Economist: Off the Charts</a>.",
    ...
    },
    {
        ...
        img: { full: "UK-bird-joy-rating-not-ship.webp", zoom: "UK-bird-joy-rating-not-ship-zoom-2.webp", chartId: ["lollipop"] },
    ...
    },
    {
        ...
        img: { full: "minnesota-federal-agent-pie-chart.webp", zoom: "minnesota-federal-agent-pie-chart-zoom.webp", chartId: ["pie"] },
    ...
    },
    {
        ...
        img: { full: "ice-cream-flavor-ranking-cnn.webp", zoom: "ice-cream-flavor-ranking-cnn-zoom.webp", chartId: ["barplot"] },
    ...
    },
    {
        ...
        img: { full: "apple-supply-chain-circle-packing.webp", zoom: "apple-supply-chain-circle-packing-zoom.webp", chartId: ["circularPacking"] },
        ...
        chartDescription: "A circular packing chart where each dot is one Apple manufacturing site, nested into bubbles by region. Highlighting China in red against the greyed-out rest makes its dominance obvious. I love the dotted texture inside each circle — it turns an abstract proportion into something you can almost count.",
        tools: undefined,
        luminosity: ["light"],
        interactive: true,
    ...
    },
    {
        ...
        img: { full: "gaza-hospital-access-bivariate.webp", zoom: "gaza-hospital-access-bivariate-zoom.webp", chartId: ["choropleth"] },
        ...
        chartDescription: "A bivariate map blending two variables into one 2D colour scale (see the legend): population density against access to health services. A 'Before / After evacuation' toggle and arrow annotations walk you through the shift. A masterclass in encoding two dimensions on one map without losing the reader.",
        tools: [{ name: "d3.js" }],
        luminosity: ["light"],
        interactive: true,
    ...
    },
    {
        ...
        img: { full: "britain-italy-years-in-office.webp", zoom: "britain-italy-years-in-office-zoom.webp", chartId: ["timeseries", "line", "area"] },
        contextDescription: "A playful take on political (in)stability between Britain and Italy: each government is a triangle whose height is its time in office — Britain pointing up, Italy down. The punchline is that Giorgia Meloni has already outlasted three British prime ministers.",
        chartDescription: "An unusual mirror chart where each government is a right triangle growing with every year in office. I'm a bit skeptical — both axes encode time, and the area scales with the square of the duration, inflating long-lived governments. But it's original, readable and genuinely fun.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "german-cheese-austria-trade.webp", zoom: "german-cheese-austria-trade-zoom.webp", chartId: ["line", "area"] },
        contextDescription: "Made for the #30DayChartChallenge (2026, day 21), this tracks Germany's cheese trade with Austria from 2001 to 2025. Both flows grew, but Germany long exported more than it imported — until the gap narrows and even flips in recent years. Data from Destatis.",
        chartDescription: "A trade-balance chart styled like an old engraved almanac: exports in gold, imports in dark ink, the gap between them shaded toward whoever leads. I love the antique typography and the curves labelled directly on the lines. A simple two-series chart given a strong editorial voice.",
        tools: [{ name: "R" }],
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "sickness-absence-netherlands.webp", zoom: "sickness-absence-netherlands-zoom.webp", chartId: ["line"] },
        contextDescription: "Sickness absence across Dutch industries from 1996 to 2025, built by Datylon on CBS StatLine data. Health and social care has sat above the national average throughout, climbing after 2015 and spiking through the COVID years — and since 2018 it tops every Dutch industry.",
        chartDescription: "A line chart where every industry is a faint grey line, with just two pulled forward — Health and social care in orange, the overall mean in black — labelled at the line ends. A soft band flags the COVID window and four annotations anchored to key moments turn a tangle of trends into a guided story.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "reuters-sleep-beeswarm.webp", zoom: "reuters-sleep-beeswarm-zoom.webp", chartId: ["beeswarm"] },
        contextDescription: "Part of a Reuters explainer on sleep, comparing how many hours a day different animals spend asleep — from the barely-sleeping red kangaroo to the marathon-napping armadillo, humans in the middle. Marine mammals sleep far less, many resting one brain hemisphere at a time so they can keep swimming.",
        chartDescription: "A beeswarm plot where each dot is a species along an axis of hours slept per day, split into a land row and a marine row. Filled dots are ordinary sleepers, hollow dots the unihemispheric ones — a neat way to encode a second qualitative variable without a colour legend. Direct labels and leader lines call out the outliers.",
        tools: undefined,
        luminosity: ["dark"],
        interactive: false,
    ...
    },
    {
        ...
        author: "Reuters Graphics",
        url: "https://www.reuters.com/graphics/HEALTH-SLEEP/mopakyjmnpa/",
        img: { full: "reuters-sleep-age-stacked.webp", zoom: "reuters-sleep-age-stacked-zoom.webp", chartId: ["barplot"] },
        contextDescription: "From the same Reuters piece, how much sleep we need at each stage of life, from newborns down to older adults. A dotted line separates total sleep across 24 hours, naps included, from sleep taken per night once daytime napping fades.",
        chartDescription: "A stacked bar chart with variable-width bars — each spans an age range, so width carries meaning as well as height. The recommended window is a hatched band bridging the asleep and awake zones, with sun and moon icons for the two halves of the day. Using the whole 24-hour clock as the frame turns a table of guidelines into a picture.",
        tools: undefined,
        luminosity: ["dark"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "france-2026-temperature-anomaly.webp", zoom: "france-2026-temperature-anomaly-zoom.webp", chartId: ["area", "line", "timeseries"] },
        contextDescription: "Daily temperatures across France in 2026 versus the 1961–1990 normal, built by Dominic Royé from Open-Meteo (ERA5) data. Almost every day ran warmer than the baseline, with only a handful of brief cold spells — a whole year of climate deviation in one frame.",
        chartDescription: "A daily time series filled against the smooth 'normal' curve — red above, blue below — so the year reads as a wash of red. Two dashed curves mark the 5th–95th percentile envelope, and peaks above it read as record territory. The diverging fill against a reference line is a technique I love for anomaly data.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "economist-world-gdp-share-stacked-area.webp", zoom: "economist-world-gdp-share-stacked-area-zoom.webp", chartId: ["stackedArea", "stream"] },
        contextDescription: "Two centuries of the world economy in one frame: each country's share of world GDP at purchasing-power parity from 1820 to 2025. It traces the rise and fall of great powers behind the article's theme of America's waning dominance. Made by Matt McLean for a piece by Sondre Ulvund Solstad in The Economist.",
        chartDescription: "A stacked area chart flipped on its side — time runs vertically, each country a coloured ribbon as wide as its GDP share. The ribbons reorder and weave past each other as ranks shift, giving a braided, woodgrain texture, with names dropped directly inside them. A gorgeous way to turn a dry stacked series into a two-century story.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "era5-europe-wind-temperature-june-2026.webp", zoom: "era5-europe-wind-temperature-june-2026-zoom.webp", chartId: ["map", "3d", "animation"] },
        contextDescription: "An animation of ERA5 reanalysis over Europe for June 2026, by Jeran Poehls, showing the 500 hPa wind field alongside 2-metre air temperature day by day. An anticyclone builds over western France in late June and drifts east — the signature of an early-summer heat build-up.",
        chartDescription: "A gorgeous scientific-art dataviz: wind is rendered as thousands of flowlines streaming across a 3D relief of Europe like windswept fur, coloured by temperature. The brushed-hair texture makes the atmosphere feel physical — not for reading exact values, but a mesmerising way to feel a month of weather.",
        tools: undefined,
        luminosity: ["dark"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "ikea-sofa-colours-timeline.webp", zoom: "ikea-sofa-colours-timeline-zoom.webp", chartId: ["heatmap", "timeseries"] },
        contextDescription: "A data story by Toon Vos for The European Correspondent, from a manual count of 3,500 couches in IKEA catalogues from 1960 to 2021. European interiors grew steadily more muted and greyer through the 2010s — though, as ever, IKEA is now reviving bold designs from its archives.",
        chartDescription: "The chart itself is the argument — a row of vertical stripes, one per year, painted in that catalogue's two most prominent sofa colours, so six decades of taste read as a single colour gradient. Patterned years get a dotted checkerboard texture. I love letting the encoding literally be the subject: colour data shown as colour.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "ticks-europe-species-map.webp", zoom: "ticks-europe-species-map-zoom.webp", chartId: ["map", "hexbin", "density2d"] },
        contextDescription: "A piece by Aliaksandra Shymanskaya and Liene Lūsīte, with visualisation by Sebastian Graeff, for The European Correspondent on how a warming climate is pushing ticks — some carrying Lyme disease or tick-borne encephalitis — further north, now even above the Arctic Circle.",
        chartDescription: "A gridded binned map: Europe is split into a square lattice, each cell shaded by how many tick species were recorded there. It's a 2D histogram over a map — like a hexbin map but with square bins — turning scattered points into a clean density surface. I like the restrained styling and the labelled dashed Arctic Circle line.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "rhine-cologne-water-level.webp", zoom: "rhine-cologne-water-level-zoom.webp", chartId: ["line", "area", "timeseries"] },
        contextDescription: "In August 2026 the Rhine at Cologne fell to a record low, well below the 2018 mark. Ansgar Wolsing charts the year's daily level against the historical envelope after a summer of drought and heat left Germany's main waterway too shallow for most loaded cargo ships — a stark image of the new climate reality.",
        chartDescription: "A time series where the 2026 daily level is a bold purple line over two nested grey bands: the full 2000–2025 range and, inside it, the 80% envelope. Watching the line dive out the bottom makes the anomaly legible. My favourite detail is the thin white stroke around the purple line that lifts it off the grey. Built in R.",
        tools: [{ name: "R" }],
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "ai-homework-exam-scores-density.webp", zoom: "ai-homework-exam-scores-density-zoom.webp", chartId: ["density", "area"] },
        contextDescription: "An Economist graphic from a June 2026 preprint of nearly 27,000 Chinese pupils. The finding: those using AI scored higher on homework and finished faster — but did worse at exam time. A cautionary tale about cognitive offloading; real learning still needs the hard work of grappling.",
        chartDescription: "Three stacked density panels — homework score, completion time, exam score — each comparing the same pupils before and while using AI, with a grey baseline for non-users. Read top to bottom, the 'using AI' hump slides right, then left, then left again. Showing the whole distribution rather than just means makes it quietly persuasive.",
        tools: undefined,
        luminosity: ["light"],
        interactive: false,
    ...
    },
    {
        ...
        img: { full: "europe-trains-live-map.webp", zoom: "europe-trains-live-map-zoom.webp", chartId: ["map", "connection", "animation"] },
        contextDescription: "An animated replay of one real day of scheduled trains across Germany, the Benelux, Switzerland and France, built from open GTFS timetables. A clock scrubs through the day while every service moves in its real position, colour-coded by category. It's one of sixteen rail networks the project covers.",
        chartDescription: "A dark-mode movement map where each train is a coloured dot trailing a comet tail, so the network pulses to life around hubs like Paris and Zürich. Rings bloom where a service begins, and speed and city presets let you explore. Rendered on plain HTML Canvas — no mapping library — a gorgeous flight-radar-style take on rail data.",
...
// Complete catalog (favorites + the rest), in ascending-id authoring order.
export const fullVizList: VizItem[] = [...favoriteVizList, ...vizList].sort(
  (a, b) => a.id - b.id,
);
